...
\begin{table}[ht]
	\caption{Performance of verification model with C++ predictor and delayed weight updates averaged over ten HYPSO-2 images for a set of PAEs.}
...
\begin{table}[ht]
	...
	\begin{center}
		\begin{tabular}{lrrr}
			\hline
			\textbf{PAE} & \textbf{CNES} & \textbf{HLM} & \textbf{Reduction} \\
			\hline
			0            & 2.002         & 1.995        & -0.371\%           \\
			1            & 2.500         & 2.488        & -0.470\%           \\
			3            & 3.095         & 3.077        & -0.565\%           \\
			7            & 3.941         & 3.912        & -0.739\%           \\
			15           & 5.262         & 5.219        & -0.826\%           \\
			\hline
		\end{tabular}
	\end{center}
\end{table}
...
\begin{figure}[ht]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{figures/hypso2-rgb/hypso_decoded.png}
	\end{center}
