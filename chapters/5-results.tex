...
\begin{table}[ht]
	...
	\begin{center}
		\begin{tabular}{lrrrrr}
			\hline
			\textbf{PAE} & \textbf{CR} & \textbf{Load Data (s)} & \textbf{Predictor (s)} & \textbf{Encoder (s)} & \textbf{Save Data (s)} \\
			\hline
...
\begin{table}[ht]
	...
	\begin{center}
		\begin{tabular}{lrrrrr}
			\hline
			\textbf{PAE} & \textbf{Load Data (s)} & \textbf{Decoder (s)} & \textbf{Predictor (s)} & \textbf{Save Data (s)} \\
			\hline
